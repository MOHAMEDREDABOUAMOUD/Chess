...
void ia::init_table()
{
    ...
    for(int i=0;i<8;i++)
    {
        for(int j=0;j<8;j++)
        {
            ...
            connect(tpiece[i][j].btn,&QPushButton::clicked,this,&ia::Possible1);
            r+=78;
        }
        s+=78;
        r=0;
...
void ia::analyseBoard(int &xd,int &yd,int &xa,int &ya)
{
    inittab();
    for(int i=0;i<8;i++)
    {
            ...
            if(t[i][j]<0 and peutJouerfunc(i,j)==1)
            {
                for(int k=0;k<8;k++)
                {
                    for(int l=0;l<8;l++)
                    {
                        if(t[k][l]>0)
                        {
                            if((possible(i,j,k,l)==1) and (cheminPlein(i,j,k,l)==0) and noteataftermove(i,j,k,l)==1 and echecKingNoirApresMove(i,j,k,l)==false)
                            {
                        ...
                        {
                            if((t[i][l]>0)and(i==3)and(t[k][l]==0)and(pion2step(i,l)==1)and(noteataftermove(i,j,k,l)==1) and echecKingNoirApresMove(i,j,k,l)==false)
                            {
                                tma[nma].xd=i;tma[nma].yd=j;tma[nma].xa=k;tma[nma].ya=l;
                                nma++;
                            }
        ...
        for(int j=0;j<8;j++)
        {
            if(t[i][j]<0 and peutJouerfunc(i,j)==1)
            {
                for(int k=0;k<8;k++)
                {
                    for(int l=0;l<8;l++)
                    {
                        if(t[k][l]==0 and possible(i,j,k,l)==1 and cheminPlein(i,j,k,l)==0 and noteataftermove(i,j,k,l)==1 and echecKingNoirApresMove(i,j,k,l)==false)
                        {
                ...
                if(t[i][j]<0 and peutJouerfunc(i,j)==1)
                {
                    for(int k=0;k<8;k++)
                    {
                        for(int l=0;l<8;l++)
                        {
                            if(t[k][l]>0)
                            {
                                if((possible(i,j,k,l)==1) and (cheminPlein(i,j,k,l)==0) and echecKingNoirApresMove(i,j,k,l)==false)
                                {
                                    tma[nma].xd=i;tma[nma].yd=j;tma[nma].xa=k;tma[nma].ya=l;
                                    nma++;
                                }
                            ...
                            {
                                if((t[i][l]>0)and(i==3)and(t[k][l]==0)and(pion2step(i,l)==1) and echecKingNoirApresMove(i,j,k,l)==false)
                                {
                                    tma[nma].xd=i;tma[nma].yd=j;tma[nma].xa=k;tma[nma].ya=l;
                                    nma++;
                                }
            ...
            for(int j=0;j<8;j++)
            {
                if(t[i][j]<0 and peutJouerfunc(i,j)==1)
                {
                    for(int k=0;k<8;k++)
                    {
                        for(int l=0;l<8;l++)
                        {
                            if(t[k][l]==0 and possible(i,j,k,l)==1 and cheminPlein(i,j,k,l)==0 and echecKingNoirApresMove(i,j,k,l)==false)
                            {
                                tmo[nmo].xd=i;tmo[nmo].yd=j;tmo[nmo].xa=k;tmo[nmo].ya=l;
                                nmo++;
                            }
...
void ia::on_pushButton1_clicked()
{
    game *g;
    g=new game(this);
    hide();
