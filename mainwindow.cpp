    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->labeltour->setText(" Tour de B ");
    ui->labelechec->setText("");
    init_table();
    Possible();
}
...
void MainWindow::init_table()
{
    ...
    for(int i=0;i<8;i++)
    {
        for(int j=0;j<8;j++)
        {
            ...
            connect(tpiece[i][j].btn,&QPushButton::clicked,this,&MainWindow::Possible);
            r+=78;
        }
        s+=78;
        r=0;
...
void MainWindow::Possible()
{
    ...
    if(finPartie(tur)==0)
    {
        ...
        else if(maxpn==true)
        {
            ...
            {
                t[xa][ya]=-3;
                tpiece[xa][ya].btn->setIcon(QIcon("C:/Users/msii/Desktop/JeuxDechec/images/black_knight"));
                tpiece[xa][ya].btn->setIconSize(QSize(90,90));
                maxpn=false;
                setFixedSize(625,685);
            }
            ...
            {
                t[xa][ya]=-2;
                tpiece[xa][ya].btn->setIcon(QIcon("C:/Users/msii/Desktop/JeuxDechec/images/black_rook"));
                tpiece[xa][ya].btn->setIconSize(QSize(90,90));
                maxpn=false;
                setFixedSize(625,685);
            }
            ...
            {
                t[xa][ya]=-4;
                tpiece[xa][ya].btn->setIcon(QIcon("C:/Users/msii/Desktop/JeuxDechec/images/black_bishop"));
                tpiece[xa][ya].btn->setIconSize(QSize(90,90));
                maxpn=false;
                setFixedSize(625,685);
            }
                ...
                if(Pmange==true)
                {
                    if(tur%2==0)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if(echecKingBalncApresMove(xd,yd,xa,ya)==false)
                                {
                                    clearETOIL();
                                    eat(but,but2,xd,yd,xa,ya);
                                    tur++;
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if(t[xd][yd]==-6)
                            {
                                if(echecKingNoirap(xa,ya,xs,ys)==false)
                                {
                                    clearETOIL();
                                    eat(but,but2,xd,yd,xa,ya);
                                    tur++;
                            ...
                            {
                                if(echecKingNoirApresMove(xd,yd,xa,ya)==false)
                                {
                                    clearETOIL();
                                    eat(but,but2,xd,yd,xa,ya);
                                    tur++;
                    ...
                    if(tur%2==0)
                    {
                        ...
                        if(echecKingBlanc(xk,yk,xs,ys)==true)
                        {
                            ui->labelechec->setText("King Blanc en echeec ");
                        }
                    }
                    else
                    {
                        ui->labeltour->setText(" Tour de N ");
                        if(echecKingNoir(xk,yk,xs,ys)==true)
                        {
                            ui->labelechec->setText(" King Noir en echeec ");
                        }
                    }
                }
                else
                                ...
                                for(int i=0;i<8;i++)
                                {
                                    for(int j=0;j<8;j++)
                                    {
                                        if (butt1==tpiece[i][j].btn and cp==0 )
                                        {
                                            ...
                                            {
                                                if(t[xd][yd]==-6 and runKing(i,j)==1)
                                                {
                                                    if(t[i][j]!=0)
                                                    {
                                                        cp=1;
